    ...
    if df.at[index, 'symbol'] == True:
        ...
        for offset in offsets:
            ...
            if 0 <= adj_index < len(df) and df.at[adj_index, 'Character'].isdigit():
                ...
                answers_dup.append((complete_digit, digit_start_pos, digit_end_pos))

answers_dup = pd.DataFrame(answers_dup, columns=['Answer', 'Start', 'End'])
print(answers_dup.tail(20))
answers = answers_dup.drop_duplicates()
total = sum(answers['Answer'])
